...
class ProductController implements ControllerInterface {
    ...
    /**
     * Procesa la petición del usuario (Action o Option)
     */
    ...
    // --- IMPLEMENTACIÓN ControllerInterface ---

    public function add() {
        // Validamos los campos requeridos para insertar
        ...
        if (empty($_SESSION['error'])) {
            ...
            if (is_null($product)) {
                ...
                if ($result) {
                    ...
                    $productValid = NULL; // Limpiamos formulario tras éxito
                }
            } else {
                array_push($_SESSION['error'], ProductMessage::ERR_FORM['exists_id']);
            }
        }
    ...
    public function searchById() {
        ...
        if (empty($_SESSION['error'])) {
            ...
            if (!is_null($product)) {
                ...
                $productValid = $product; // Cargamos datos encontrados
            } else {
                array_push($_SESSION['error'], ProductMessage::ERR_FORM['not_found']);
            }
        }
    ...
    public function delete() {
        ...
        if (empty($_SESSION['error'])) {
            ...
            if ($result) {
                ...
                $productValid = NULL; // Limpiamos tras borrar
            }
        }
        $this->view->display("view/form/ProductFormSModDel.php", $productValid);
    }
