...
class ProductModel {
    ...
    // AGREGA ESTE DEBUG TEMPORAL
    echo "<p style='background: cyan;'>DEBUG ProductModel: Categorías obtenidas = " . count($categories) . "</p>";
    if (!empty($categories)) {
        foreach ($categories as $cat) {
            echo "- " . $cat->getId() . " : " . $cat->getName() . "<br>";
        }
    } else {
        echo "<p style='color: red;'>ProductModel: Array de categorías está VACÍO</p>";
    }
